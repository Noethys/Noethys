...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des régimes sociaux. Ceux-ci sont ensuite associés à des caisses."
        titre = u"Gestion des régimes sociaux"
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des régimes sociaux")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un régime social")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le régime social sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le régime social sélectionné dans la liste")
