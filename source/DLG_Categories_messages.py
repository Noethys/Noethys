...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des catégories de messages."
        titre = u"Gestion des catégories de messages"
        ...
        self.ctrl_recherche = OL_Categories_messages.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des catégories de messages")
