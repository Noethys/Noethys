...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des catégories comptables."
        titre = u"Gestion des catégories comptables"
        ...
        self.radio_debit = wx.RadioButton(self, -1, u"Débit", style=wx.RB_GROUP)
        self.radio_credit = wx.RadioButton(self, -1, u"Crédit")
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des catégories comptables")
