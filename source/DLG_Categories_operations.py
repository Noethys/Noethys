...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des catégories comptables.")
        titre = _(u"Gestion des catégories comptables")
        ...
        self.radio_debit = wx.RadioButton(self, -1, _(u"Débit"), style=wx.RB_GROUP)
        self.radio_credit = wx.RadioButton(self, -1, _(u"Crédit"))
    ...
    def __set_properties(self):
        self.SetTitle(_(u"Gestion des catégories comptables"))
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter une catégorie"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier la catégorie sélectionnée dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer la catégorie sélectionnée dans la liste"))
