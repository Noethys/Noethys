...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        # Bandeau
        intro = u"Saisissez ici les coordonnées bancaires du compte de la famille à débiter afin d'activer le prélèvement automatique."
        titre = u"Prélèvement automatique"
        self.SetTitle(titre)
        ...
        self.label_activation = wx.StaticText(self, -1, u"Prélèvement activé :")
        ...
        # Mandats
        self.box_mandats_staticbox = wx.StaticBox(self, -1, u"Mandats SEPA")
        ...
        self.bouton_rib = wx.Button(self, -1, u"Saisie d'un RIB (Prélèvements nationaux)")
    ...
    def __set_properties(self):
        self.radio_activation_oui.SetToolTipString(u"Cliquez ici pour activer le prélèvement")
        self.radio_activation_non.SetToolTipString(u"Cliquez ici pour désactiver le prélèvement")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un mandat")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le mandat sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le mandat sélectionné dans la iste")
        self.bouton_aide.SetToolTipString(u"Cliquez ici pour obtenir de l'aide")
        self.bouton_rib.SetToolTipString(u"Cliquez ici pour paramétrer un RIB pour les prélèvements nationaux (jusqu'au 1er février 2014)")
    ...
    def OnBoutonFermer(self, event):
        ...
        if activation == True :
            ...
            # Pas d'activation
            dlg = wx.MessageDialog(None, u"Vous confirmez que vous ne souhaitez pas activer le prélèvement automatique ?", u"Confirmation", wx.YES_NO|wx.YES_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
