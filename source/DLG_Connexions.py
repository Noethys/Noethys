...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici consulter la liste complète des connexions au serveur MySQL."
        titre = u"Connexions réseau"
    ...
    def __set_properties(self):
        self.SetTitle(u"Connexions réseau")
        self.bouton_apercu.SetToolTipString(u"Cliquez ici pour visualiser un aperçu avant impression")
