...
import OL_Prestations_repartition
...
##        self.Thaw() 
    ...
    def Remplissage(self):
        ...
        self.imgVert = il.Add(wx.Bitmap("Images/16x16/Ventilation_vert.png", wx.BITMAP_TYPE_PNG))
        self.imgRouge = il.Add(wx.Bitmap("Images/16x16/Ventilation_rouge.png", wx.BITMAP_TYPE_PNG))
        self.imgOrange = il.Add(wx.Bitmap("Images/16x16/Ventilation_orange.png", wx.BITMAP_TYPE_PNG))
        self.imgAttente = il.Add(wx.Bitmap("Images/16x16/Attente.png", wx.BITMAP_TYPE_PNG))
        self.imgOk = il.Add(wx.Bitmap("Images/16x16/Ok.png", wx.BITMAP_TYPE_PNG))
        self.imgNon = il.Add(wx.Bitmap("Images/16x16/Interdit.png", wx.BITMAP_TYPE_PNG))
