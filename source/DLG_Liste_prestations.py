...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici consulter la liste complète des prestations créées dans le logiciel. Les commandes proposées vous permettent de modifier, supprimer ou imprimer des prestations. Pour supprimer un lot de prestations, cochez-les et utilisez le bouton Supprimer."
        titre = u"Liste des prestations"
        ...
        self.label_facture = wx.StaticText(self, -1, u"Facturée :")
        self.ctrl_facture = wx.Choice(self, -1, choices = (u"Toutes", u"Oui", u"Non"))
    ...
    def __set_properties(self):
        self.SetTitle(u"Liste des prestations")
