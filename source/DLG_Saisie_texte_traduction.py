...
class CTRL_Avertissement(wx.Panel):
    def __init__(self, parent, texte=u"", couleurFond=wx.Colour(255, 147, 132)):
        ...
        self.ctrl_image = wx.StaticBitmap(self, -1, wx.Bitmap("Images/32x32/Attention.png", wx.BITMAP_TYPE_ANY))
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.ctrl_texte.SetToolTipString(_(u"Texte original"))
        self.ctrl_traduction.SetToolTipString(_(u"Saisissez une traduction"))
