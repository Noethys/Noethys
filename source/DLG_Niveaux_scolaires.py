...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des niveaux scolaires. Ceux-ci peuvent ensuite être attribués à des classes.")
        titre = _(u"Gestion des niveaux scolaires")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un niveau"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le niveau sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le niveau sélectionné dans la liste"))
        self.bouton_monter.SetToolTipString(_(u"Cliquez ici pour monter le niveau sélectionné dans la liste"))
        self.bouton_descendre.SetToolTipString(_(u"Cliquez ici pour descendre le niveau sélectionné dans la liste"))
