...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des niveaux scolaires. Ceux-ci peuvent ensuite être attribués à des classes."
        titre = u"Gestion des niveaux scolaires"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Niveaux_scolaires.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un niveau")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le niveau sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le niveau sélectionné dans la liste")
        self.bouton_monter.SetToolTipString(u"Cliquez ici pour monter le niveau sélectionné dans la liste")
        self.bouton_descendre.SetToolTipString(u"Cliquez ici pour descendre le niveau sélectionné dans la liste")
