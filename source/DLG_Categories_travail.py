...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des catégories socio-professionnelles. Celles-ci sont utilisées dans les fiches individuelles."
        titre = u"Gestion des catégories socio-professionnelles"
        ...
        self.ctrl_recherche = OL_Categories_travail.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des catégories socio-professionnelles")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter une catégorie")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier la catégorie sélectionnée dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer la catégorie sélectionnée dans la liste")
