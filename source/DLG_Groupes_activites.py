...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un groupe d'activité"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le groupe d'activité sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le groupe d'activité sélectionné dans la liste"))
