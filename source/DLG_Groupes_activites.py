...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des groupes d'activités. Ceux-ci sont ensuite associés à des activités afin de faciliter, par exemple, l'édition de factures ou d'attestations groupées..."
        titre = u"Gestion des groupes d'activités"
        ...
        self.ctrl_recherche = OL_Groupes_activites.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des groupes d'activités")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un groupe d'activité")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le groupe d'activité sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le groupe d'activité sélectionné dans la liste")
