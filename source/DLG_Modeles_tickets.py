...
class Dialog(wx.Dialog):
    def __init__(self, parent, categorie=None):
        wx.Dialog.__init__(self, parent, -1, name="DLG_modeles_tickets", style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX|wx.THICK_FRAME)
        self.parent = parent
        
        # Bandeau
        titre = u"Modèles de tickets"
        intro = u"Vous pouvez paramétrer ici des modèles de tickets qui sont utilisables uniquement avec des imprimantes de tickets."
        self.SetTitle(titre)
