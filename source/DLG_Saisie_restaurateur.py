...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Nom
        self.staticbox_nom_staticbox = wx.StaticBox(self, -1, u"Nom du restaurateur")
    ...
    def __set_properties(self):
        self.SetTitle(u"Ajout d'un restaurateur")
        self.ctrl_nom.SetToolTipString(u"Saisissez le nom du restaurateur")
