...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des lots de prélèvements."
        titre = u"Gestion des lots de prélèvements"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Lots_prelevements.BarreRecherche(self)
