...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des caisses. Ces données sont ensuite utilisées dans les fiches familiales."
        titre = u"Gestion des caisses"
        ...
        self.ctrl_recherche = OL_Caisses.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des caisses")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter une caisse")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier la caisse sélectionnée dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer la caisse sélectionnée dans la iste")
