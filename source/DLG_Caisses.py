...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter une caisse"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier la caisse sélectionnée dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer la caisse sélectionnée dans la iste"))
