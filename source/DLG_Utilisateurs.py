...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des utilisateurs. Il existe 2 profils d'utilisateurs : les simples utilisateurs et les administrateurs qui ont, en plus, l'autorisation de créer, modifier ou supprimer des utilisateurs."
        titre = u"Gestion des utilisateurs"
        ...
        self.ctrl_recherche = OL_Utilisateurs.BarreRecherche(self)
        ...
        self.bouton_historique = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Horloge3.png", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des utilisateurs")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un utilisateur")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier l'utilisateur sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer l'utilisateur sélectionné dans la liste")
        self.bouton_historique.SetToolTipString(u"Cliquez ici pour afficher l'historique de l'utilisateur sélectionné dans la liste")
