...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des modèles de contrats.Ceux-ci permettent une saisie plus rapide des contrats."
        titre = u"Gestion des modèles de contrats"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Modeles_contrats.BarreRecherche(self)
