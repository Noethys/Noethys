...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des préfixes de factures.")
        titre = _(u"Gestion des préfixes de factures")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un préfixe de facture"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le préfixe sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le préfixe sélectionné dans la liste"))
