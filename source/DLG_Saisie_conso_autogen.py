...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDactivite=None, IDunite=None):
        ...
        self.bouton_heure_debut_formule = wx.BitmapButton(self, -1, wx.Bitmap(u"Images/16x16/Modifier.png", wx.BITMAP_TYPE_ANY))
        ...
        self.bouton_heure_fin_formule = wx.BitmapButton(self, -1, wx.Bitmap(u"Images/16x16/Modifier.png", wx.BITMAP_TYPE_ANY))
