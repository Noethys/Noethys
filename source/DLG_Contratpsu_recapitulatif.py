...
import wx
import OL_Contratspsu_recapitulatif
...
class Panel(wx.Panel):
    def __init__(self, parent, clsbase=None):
        ...
        self.bouton_recapitulatif_apercu = wx.BitmapButton(self, -1, wx.Bitmap(u"Images/16x16/Apercu.png", wx.BITMAP_TYPE_ANY))
        self.bouton_recapitulatif_imprimer = wx.BitmapButton(self, -1, wx.Bitmap(u"Images/16x16/Imprimante.png", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.bouton_recapitulatif_apercu.SetToolTipString(_(u"Cliquez ici pour afficher un aperçu avant impression de la liste"))
        self.bouton_recapitulatif_imprimer.SetToolTipString(_(u"Cliquez ici pour imprimer la liste"))
