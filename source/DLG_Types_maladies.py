...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des maladies. Précisez si la législation impose un vaccin obligatoire pour chaque maladie saisie."
        titre = u"Gestion des maladies"
        ...
        self.ctrl_recherche = OL_Types_maladies.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des maladies")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter une maladie")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier la maladie sélectionnée dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer la maladie sélectionnée dans la iste")
