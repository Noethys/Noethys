...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des budgets."
        titre = u"Gestion des budgets"
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un budget")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le budget sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le budget sélectionné dans la liste")
