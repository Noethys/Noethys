...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des noms de lots de factures. Notez que la suppression d'un lot de factures ici n'entraîne pas la suppression des factures associées."
        titre = u"Gestion des lots de factures"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Lots_factures.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un lot")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le lot dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le lot sélectionné dans la liste")
