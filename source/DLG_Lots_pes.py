...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des bordereaux PES ORMC."
        titre = u"Gestion des bordereaux PES ORMC"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Lots_pes.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour créer un bordereau")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le bordereau sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le bordereau sélectionné dans la liste")
