...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDpiece=None, IDfamille=None, IDindividu=None, dictFamillesRattachees={}):
        ...
        self.bouton_visualiser_page = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Loupe.png", wx.BITMAP_TYPE_ANY))
        self.bouton_zoom_plus = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/zoom_plus.png", wx.BITMAP_TYPE_ANY))
