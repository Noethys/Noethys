...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des types de quotients. Ceux-ci sont ensuite associés à des quotients dans les fiches familles.")
        titre = _(u"Gestion des types de quotients")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un type de quotient"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le type de quotient sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le type de quotient sélectionné dans la liste"))
