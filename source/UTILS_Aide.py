...
def Aide(page=None):
    ...
    # Temporaire :
##    dlg = wx.MessageDialog(None, u"Le manuel de l'utilisateur sera disponible à partir de septembre 2013.\n\nPour obtenir de l'aide, vous pouvez déjà :\n\n   > Télécharger le guide de démarrage rapide\n   > Consulter le forum d'entraide\n   > Visionner les tutoriels vidéos", u"Aide indisponible", wx.OK | wx.ICON_INFORMATION)
##    dlg.ShowModal()
##    dlg.Destroy()
##    return
    ...
    if page == "" :
        dlg = wx.MessageDialog(None, u"Cette rubrique d'aide n'est pas encore disponible.\n\nSouhaitez-vous être redirigé vers le sommaire de l'aide ?", u"Pas de rubrique disponible", wx.YES_NO|wx.YES_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
