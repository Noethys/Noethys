...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Boutons de commande
        self.bouton_ok = wx.BitmapButton(self, -1, wx.Bitmap("Images/BoutonsImages/Utiliser_Noethys.png", wx.BITMAP_TYPE_ANY), size=(200, -1))
    ...
    def __set_properties(self):
        ...
        self.bouton_ok.SetToolTipString(u"Cliquez ici pour fermer cette fenêtre et utiliser Noethys")
