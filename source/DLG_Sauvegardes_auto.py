...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des procédures de sauvegardes automatiques. Ces sauvegardes sont réalisées lors de la fermeture du fichier de données ou du logiciel en fonction des paramètres et conditions de votre choix."
        titre = u"Sauvegardes automatiques"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Sauvegardes_auto.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter une procédure de sauvegarde")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier la procédure de sauvegarde sélectionnée dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer la procédure de sauvegarde sélectionnée dans la liste")
