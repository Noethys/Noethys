...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter une procédure de sauvegarde"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier la procédure de sauvegarde sélectionnée dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer la procédure de sauvegarde sélectionnée dans la liste"))
