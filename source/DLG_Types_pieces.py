...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des types de pièces. Vous pouvez définir une période de validité pour chacune des pièces et choisir d'associer ces types de pièces à des individus ou à des familles."
        titre = u"Gestion des types de pièces"
        ...
        self.ctrl_recherche = OL_Types_pieces.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des types de pièces")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un type de pièce")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le type de pièce sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le type de pièce sélectionné dans la liste")
