...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des noms de lots de rappels. Notez que la suppression d'un lot de rappels ici n'entraîne pas la suppression des rappels associés."
        titre = u"Gestion des lots de rappels"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Lots_rappels.BarreRecherche(self)
