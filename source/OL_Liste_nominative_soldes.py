...
LISTE_CHAMPS = [
    {"label":u"IDindividu", "code":"IDindividu", "champ":"inscriptions.IDindividu", "align":"left", "largeur":0, "stringConverter":None, "actif":False, "afficher":False},
    ...
    {"label":u"Groupe", "code":"nomGroupe", "champ":"groupes.nom", "align":"left", "largeur":85, "stringConverter":None, "actif":True, "afficher":True},
    ...
    {"label":u"Solde", "code":"totalSolde", "champ":None, "align":"right", "largeur":95, "stringConverter":"solde", "imageGetter":"ventilation", "actif":True, "afficher":True},
