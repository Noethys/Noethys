...
class CTRL(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.checkbox_codeBarre.SetToolTipString(_(u"Cochez cette case pour insérer un code-barre pour le numéro de lettre"))
        self.checkbox_repertoire.SetToolTipString(_(u"Cochez cette case pour enregistrer un exemplaire de chaque lettre de rappel au format PDF dans le répertoire indiqué"))
