...
class CTRL(wx.Panel):
    def __init__(self, parent):
        ...
        self.checkbox_coupon = wx.CheckBox(self, -1, u"Insérer le coupon-réponse")
        self.checkbox_codeBarre = wx.CheckBox(self, -1, u"Insérer les codes-barres")
    ...
    def __set_properties(self):
        self.ctrl_modele.SetToolTipString(u"Sélectionnez le modèle")
        self.bouton_modele.SetToolTipString(u"Cliquez ici pour accéder à la gestion des modèles")
        self.checkbox_coupon.SetToolTipString(u"Cochez cette case pour insérer un coupon à découper")
        self.checkbox_codeBarre.SetToolTipString(u"Cochez cette case pour insérer un code-barre pour le numéro de lettre")
        self.checkbox_repertoire.SetToolTipString(u"Cochez cette case pour enregistrer un exemplaire de chaque lettre de rappel au format PDF dans le répertoire indiqué")
