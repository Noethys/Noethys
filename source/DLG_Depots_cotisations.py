...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        titre = u"Gestion des dépôts de cotisations"
        ...
        self.staticbox_cotisations = wx.StaticBox(self, -1, u"Cotisations disponibles")
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des dépôts de cotisations")
