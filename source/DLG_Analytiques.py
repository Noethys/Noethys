...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des postes analytiques")
    ...
    def __set_properties(self):
        self.SetTitle(_(u"Gestion des postes analytiques"))
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un poste analytique"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le poste sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le poste sélectionné dans la liste"))
        self.bouton_defaut.SetToolTipString(_(u"Cliquez ici pour définir le poste sélectionné comme celui par défaut"))
