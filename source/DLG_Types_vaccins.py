...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_(u"Gestion des vaccins"))
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un vaccin"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le vaccin sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le vaccin sélectionné dans la liste"))
