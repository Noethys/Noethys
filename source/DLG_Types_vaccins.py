...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des vaccins. Lorsque vous saisissez un nouveau vaccin, pensez à y associer la ou les maladies qu'il est sensé vacciné."
        titre = u"Gestion des vaccins"
        ...
        self.ctrl_recherche = OL_Types_vaccins.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des vaccins")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un vaccin")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le vaccin sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le vaccin sélectionné dans la liste")
