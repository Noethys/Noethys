...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.check_afficher_page_accueil.SetToolTipString("Afficher cette unité dans le cadre Effectifs de la page d'accueil")
        self.check_afficher_grille_conso.SetToolTipString("Afficher cette unité dans la grille des consommations")
