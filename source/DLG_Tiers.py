...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des tiers."
        titre = u"Gestion des tiers"
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des tiers")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un tiers")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le tiers sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le tiers sélectionné dans la liste")
