...
class CTRL(wx.Panel):
    def __init__(self, parent, filtres=[], codesColonnes = ["IDcotisation", "date_debut", "date_fin", "beneficiaires", "rue", "cp", "ville", "nom", "numero", "montant", "solde", "date_creation_carte", "depot_nom"], \
        ...
        self.ctrl_cotisations = OL_Liste_cotisations.ListView(self, id=-1, codesColonnes=codesColonnes, checkColonne=checkColonne, triColonne=triColonne, 
    ...
    def __set_properties(self):
        self.bouton_apercu.SetToolTipString(u"Cliquez ici pour afficher un aperçu de la cotisation sélectionnée")
        self.bouton_email.SetToolTipString(u"Cliquez ici envoyer la cotisation sélectionnée par Email")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer la cotisation sélectionnée ou les cotisations cochées")
    ...
    def __do_layout(self):
        ...
        grid_sizer_liste.Add(self.ctrl_cotisations, 1, wx.EXPAND, 0)
