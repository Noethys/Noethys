...
from CTRL_Tarification_calcul import CHAMPS_TABLE_LIGNES, LISTE_COLONNES, LISTE_METHODES
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.bouton_apercu.SetToolTipString(_(u"Cliquez ici pour afficher un aperçu avant impression"))
