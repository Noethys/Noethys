...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des listes de diffusion. Ces listes peuvent être utilisées pour abonner par exemple un individu à une lettre mensuelle internet."
        titre = u"Gestion des listes de diffusion"
        ...
        self.ctrl_recherche = OL_Listes_diffusion.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des listes de diffusion")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter une liste de diffusion")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier la liste de diffusion sélectionnée")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer la liste de diffusion sélectionnée")
