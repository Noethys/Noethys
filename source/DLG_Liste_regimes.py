...
##        self.check_concernes = wx.CheckBox(self, -1, u"Ne pas afficher les dossiers complets")
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici consulter et imprimer la liste des régimes, caisses et numéros d'allocataire de chaque famille. Sélectionnez un ou plusieurs groupes d'activités ou certaines activités en particulier avant de cliquer sur le bouton 'Rafraîchir la liste' pour afficher les résultats."
        titre = u"Liste des régimes et caisses"
        ...
        self.ctrl_recherche = OL_Liste_regimes.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Liste des régimes et caisses")
