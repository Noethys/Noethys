...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter une école"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier l'école sélectionnée dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer l'école sélectionnée dans la iste"))
