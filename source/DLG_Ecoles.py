...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, -1, name="DLG_Ecoles", style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX|wx.THICK_FRAME)
        self.parent = parent
        
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des écoles. Vous pouvez renseigner les coordonnées de l'établissement ainsi que les secteurs géographiques rattachés. Vous pourrez ensuite inscrire les individus dans ces écoles depuis les fiches individuelles."
        titre = u"Gestion des écoles"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Ecoles.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter une école")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier l'école sélectionnée dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer l'école sélectionnée dans la iste")
