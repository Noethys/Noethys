...
import GestionDB
import CTRL_Bandeau
import OL_Cotisations_manquantes
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        titre = u"Liste des cotisations manquantes"
        ...
        self.ctrl_recherche = OL_Cotisations_manquantes.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Liste des cotisations manquantes")
    ...
    def GetLabelParametres(self):
        ...
        if self.ctrl_parametres.ctrl_options.GetConcernes() == True :
            listeParametres.append(u"Uniquement les dossiers incomplets")
        ...
        if presents == None :
            ...
            listeParametres.append(u"Uniquement les présents du %s au %s" % (DateEngFr(str(presents[0])), DateEngFr(str(presents[1]))))
