...
TEXTE_INTRO = u"Je soussigné{SIGNATAIRE_GENRE} {SIGNATAIRE_NOM}, {SIGNATAIRE_FONCTION}, atteste avoir accueilli {NOMS_INDIVIDUS} sur la période du {DATE_DEBUT} au {DATE_FIN} selon le détail suivant :"
...
class CTRL_Parametres(CTRL_Propertygrid.CTRL) :
    ...
    def Remplissage(self):
        ...
        # Catégorie 
        self.Append( wxpg.PropertyCategory(u"Signataire") )

        propriete = wxpg.EnumProperty(label=u"Signataire du document", name="signataire", value=0)
        propriete.SetHelpString(u"Sélectionnez le signataire du document (à renseigner au préalable dans le paramétrage de l'activité)")
        propriete.SetAttribute("obligatoire", True)
        ...
        propriete = wxpg.StringProperty(label=u"Titre du document", name="texte_titre", value=u"Attestation de présence")
        propriete.SetHelpString(u"Saisissez le titre du document (Par défaut 'Attestation de présence'). Vous pouvez intégrer les mots-clés suivants : %s" % ", ".join(listeChamps)) 
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete = wxpg.LongStringProperty(label=u"Texte d'introduction", name="texte_introduction", value=TEXTE_INTRO)
        propriete.SetHelpString(u"Saisissez un texte d'introduction. Vous pouvez intégrer les mots-clés suivants : %s" % ", ".join(listeChamps)) 
        self.Append(propriete)
        ...
        propriete = wxpg.EnumProperty(label=u"Style de texte introduction", name="style_texte_introduction", labels=[u"Normal", u"Italique", "Gras", u"Italique + Gras"], values=[0, 1, 2, 3] , value=1)
        ...
        propriete = wxpg.EnumProperty(label=u"Alignement du texte d'introduction", name="alignement_texte_introduction", labels=[u"Gauche", u"Centre", u"Droite"], values=[0, 1, 2] , value=1)
