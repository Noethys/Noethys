...
class Calendrier(wx.ScrolledWindow):
    def __init__(self,parent,ID=-1, multiSelections=True, selectionInterdite=False, typeCalendrier="mensuel"):
        ...
        self.couleurFond = (210, 210, 210) #(255, 255, 255)       # Couleur du fond du calendrier
...
##        self.pdc = wx.ClientDC(self) #wx.PseudoDC()
...
##        r = self.pdc.GetIdBounds(IDobjet)
        
        r = self.dictObjets[IDobjet]
        self.OffsetRect(r)
