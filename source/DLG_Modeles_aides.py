...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des modèles d'aides journalières.Vous pouvez par exemple saisir ici les paramètres de bons vacances CAF ou MSA que vous importez ensuite facilement dans les fiches familles."
        titre = u"Gestion des modèles d'aides journalières"
        ...
        self.ctrl_recherche = OL_Aides.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des modèles d'aides journalières")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un modèle d'aide journalière")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le modèle sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le modèle sélectionné dans la iste")
