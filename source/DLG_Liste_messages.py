...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des messages."
        titre = u"Liste des messages"
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Liste_messages.BarreRecherche(self)
    ...
    def __set_properties(self):
        ...
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le message sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le message sélectionné dans la liste")
