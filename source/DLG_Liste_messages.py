...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des messages.")
        titre = _(u"Liste des messages")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        ...
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le message sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le message sélectionné dans la liste"))
