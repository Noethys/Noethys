...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un secteur géographique"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le secteur géographique dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le secteur géographique sélectionné dans la liste"))
