...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des secteurs géographiques. Ceux-ci peuvent être attribués à des individus en même temps que l'adresse à des fins statistiques."
        titre = u"Gestion des secteurs géographiques"
        ...
        self.ctrl_recherche = OL_Secteurs.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des secteurs géographiques")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un secteur géographique")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le secteur géographique dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le secteur géographique sélectionné dans la liste")
