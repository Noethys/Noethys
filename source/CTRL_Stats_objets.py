...
class CTRL_Objets(CT.CustomTreeCtrl):
    def __init__(self, parent, liste_objets=[], id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.SUNKEN_BORDER) :
        ...
        self.dictImages = {
            "rubrique" : {"img" : wx.Bitmap('Images/16x16/Rubrique.png', wx.BITMAP_TYPE_PNG), "index" : None},
            "page" : {"img" : wx.Bitmap('Images/16x16/Page.png', wx.BITMAP_TYPE_PNG), "index" : None},
            "texte" : {"img" : wx.Bitmap('Images/16x16/Texte2.png', wx.BITMAP_TYPE_PNG), "index" : None},
            "tableau" : {"img" : wx.Bitmap('Images/16x16/Tableau.png', wx.BITMAP_TYPE_PNG), "index" : None},
            "graphe" : {"img" : wx.Bitmap('Images/16x16/Barres2.png', wx.BITMAP_TYPE_PNG), "index" : None},
            }
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        from DLG_Stats import LISTE_OBJETS as liste_objets
