...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici générer des lettres de rappel. Page 1 : Sélectionnez des paramètres puis cliquez sur Suite pour afficher les rappels disponibles. Page 2 : Cochez les rappels à générer puis cliquez sur Suite. Page 3 : Vous pouvez effectuer d'autres actions sur les lettres de rappel générées."
        titre = u"Génération de lettres de rappel"
        self.SetTitle(titre)
