...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(u"ID", "left", 0, "IDtype_vaccin"),
            ColumnDefn(u"Nom du vaccin", 'left', 200, "nom"),
            ColumnDefn(u"Durée de validité", "left", 140, "txt_duree_validite"), 
            ColumnDefn(u"Maladies associées", "left", 220, "txt_maladies_associees"), 
            ]
