...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(u"", "left", 0, "IDreleve"),
            ColumnDefn(u"Exercice", 'left', 120, "label_exercice"),
            ColumnDefn(u"Analytique", "left", 120, "label_analytique"),
            ColumnDefn(u"Catégorie", "left", 150, "label_categorie"),
            ColumnDefn(u"Libellé", "left", 120, "libelle", isSpaceFilling=True),
            ColumnDefn(u"Montant", "right", 100, "montant", stringConverter=FormateMontant),
            ]
