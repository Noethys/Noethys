...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des profils de liste. Vous pouvez ainsi retrouver facilement les champs paramétrés."
        titre = u"Gestion des profils de liste"
        ...
        self.ctrl_recherche = OL_Etat_nomin_profils.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des profils de liste")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un profil")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le profil sélectionnée")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le profil sélectionné")
