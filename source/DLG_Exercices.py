...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des exercices comptables."
        titre = u"Gestion des exercices comptables"
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des exercices comptables")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un exercice")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier l'exercice sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer l'exercice sélectionné dans la liste")
        self.bouton_defaut.SetToolTipString(u"Cliquez ici pour définir l'exercice sélectionné comme celui par défaut")
