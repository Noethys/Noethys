...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des types de cotisations."
        titre = u"Gestion des types de cotisations"
        ...
        self.ctrl_recherche = OL_Types_cotisations.BarreRecherche(self)
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des types de cotisations")
        self.bouton_ajouter.SetToolTipString(u"Cliquez ici pour ajouter un type de cotisation")
        self.bouton_modifier.SetToolTipString(u"Cliquez ici pour modifier le type de cotisation sélectionné dans la liste")
        self.bouton_supprimer.SetToolTipString(u"Cliquez ici pour supprimer le type de cotisation sélectionné dans la liste")
        self.bouton_defaut.SetToolTipString(u"Cliquez ici pour définir le type de cotisation sélectionnée comme celle par défaut")
