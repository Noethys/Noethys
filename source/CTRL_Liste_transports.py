...
##        self.Bind(wx.EVT_TREE_ITEM_RIGHT_CLICK, self.OnContextMenu)
    ...
    def Remplissage(self, listeDates=[], dictFiltres={}):        
        ...
        for categorie in listeCategories :
            ...
            self.SetItemBackgroundColour(brancheCategorie, COULEUR_FOND_REGROUPEMENT)
...
##        self.MAJ() 
    ...
    def Imprimer(self, event=None):
        ...
        for dictCategorie in self.dictImpression["donnees"] :
            ...
            ligne = [ParagraphAndImage(Paragraph(label, paraStyle), Image("Images/32x32/%s.png" % img, width=8, height=8), xpad=1, ypad=0, side="left"),]
            for date in listeDates :
