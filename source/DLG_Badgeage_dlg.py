...
class CTRL_Bouton_toggle_archive(wx.PyControl):
    ...
    def DrawTexte(self, dc):
        ...
        if self.selection == True :
            bmp = wx.Bitmap("Images/Badgeage/Droite_48x48.png", wx.BITMAP_TYPE_ANY)
            dc.SetTextForeground((0, 0, 0))
        else :
            bmp = wx.Bitmap("Images/Badgeage/Droite_gris_48x48.png", wx.BITMAP_TYPE_ANY)
...
class DLG_Question(wx.Dialog):
    def __init__(self, interface, message=u"", icone=None, couleurClaire=wx.Colour(206, 196, 190), couleurFoncee=wx.Colour(169, 156, 146),
        ...
        # Icone
        if icone == "erreur" : bmp = wx.Bitmap("Images/Badgeage/Erreur.png", wx.BITMAP_TYPE_ANY)
        elif icone == "exclamation" : bmp = wx.Bitmap("Images/Badgeage/Exclamation.png", wx.BITMAP_TYPE_ANY)
        elif icone == "information" : bmp = wx.Bitmap("Images/Badgeage/Information.png", wx.BITMAP_TYPE_ANY)
        elif icone == "question" : bmp = wx.Bitmap("Images/Badgeage/Question.png", wx.BITMAP_TYPE_ANY)
        elif icone == "commentaire" : bmp = wx.Bitmap("Images/Badgeage/Commentaire.png", wx.BITMAP_TYPE_ANY)
...
##        self.label_message = wx.StaticText(self, -1, u"\n".join(message))
        ...
        # Boutons
        self.ctrl_non = GB.GradientButton(self, -1, wx.Bitmap("Images/Badgeage/%s" % image_non, wx.BITMAP_TYPE_ANY), u" %s " % texte_non)
        ...
        self.ctrl_oui = GB.GradientButton(self, -1, wx.Bitmap("Images/Badgeage/%s" % image_oui, wx.BITMAP_TYPE_ANY), u" %s " % texte_oui)
