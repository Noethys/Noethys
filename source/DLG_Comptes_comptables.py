...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = u"Vous pouvez ici saisir, modifier ou supprimer des comptes comptables."
        titre = u"Gestion des comptes comptables"
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des comptes comptables")
