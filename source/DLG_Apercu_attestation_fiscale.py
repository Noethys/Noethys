...
class Dialog(wx.Dialog):
    def __init__(self, parent, provisoire=False, titre=u"Aperçu d'une attestation fiscale", intro=u"Vous pouvez ici créer un aperçu PDF du document sélectionné."):
