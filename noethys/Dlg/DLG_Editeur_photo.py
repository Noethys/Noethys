...
##        print self.source.GetSize()
    ...
    def Draw(self,dc):
        ...
        dc.DrawText(_(u"Cadre de s�lection"), self.posxCadre+3, self.posyCadre+1) 
...
class Dialog(wx.Dialog):
    def __init__(self, parent, image=None, tailleCadre=(384, 384), titre=_(u"Editeur photo"), listeVisages=[]):
        ...
        self.staticBox_reinit = wx.StaticBox(self, -1, _(u"R�initialisation"))
    ...
    def __set_properties(self):
        ...
        self.bouton_reinit.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour r�initialiser la position\net la taille de la photo initiale")))
