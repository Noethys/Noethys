...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        intro = _(u"Vous pouvez ici consulter la liste complète des devis créés dans le logiciel.")
        titre = _(u"Liste des devis")
    ...
    def __set_properties(self):
        self.SetTitle(_(u"Liste des devis"))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour ouvrir la fiche famille du devis sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour supprimer le devis sélectionné dans la liste")))
