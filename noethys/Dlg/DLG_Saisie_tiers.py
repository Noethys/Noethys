...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_(u"Saisissez le nom du tiers")))
        self.ctrl_observations.SetToolTip(wx.ToolTip(_(u"Saisissez des observations sur le tiers")))
