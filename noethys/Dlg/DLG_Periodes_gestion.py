...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des périodes de gestion. Les périodes de gestion permettent de verrouiller les données sur une période choisie.")
        titre = _(u"Gestion des périodes de gestion")
        self.SetTitle(titre)
