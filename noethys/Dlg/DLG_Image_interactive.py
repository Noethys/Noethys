...
#     def __init__(self, parent, IDmodele=None, categorie="categorie_produits"):
...
#         interactive_data = Data(IDcategorie=1)
#
#         # Création des widgets
#         couleur_zone_travail = wx.Colour(255, 255, 255)
#         self.ctrl_canvas = Panel_canvas(self, IDmodele=IDmodele, categorie=categorie, couleur_zone_travail=couleur_zone_travail,
