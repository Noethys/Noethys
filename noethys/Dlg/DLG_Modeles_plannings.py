...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des modèles de plannings.Ceux-ci sont notamment utilisés pour la génération automatique de consommations dans les contrats.")
        titre = _(u"Gestion des modèles de plannings")
        self.SetTitle(titre)
