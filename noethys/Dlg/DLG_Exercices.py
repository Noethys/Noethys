...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un exercice"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier l'exercice sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer l'exercice sélectionné dans la liste"))
        self.bouton_defaut.SetToolTipString(_(u"Cliquez ici pour définir l'exercice sélectionné comme celui par défaut"))
