...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_assistant.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour génèrer automatiquement les p�riodes")))
        ...
        self.bouton_modifier_montants.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour modifier le montant de toutes les prestations non factur�es")))
