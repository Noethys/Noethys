...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _(u"Vous pouvez ici consulter les locations sous forme de tableau. Pour ajouter une location, vous devez double-cliquer sur une ligne. Pour modifier une location affichée, double-cliquez sur la barre représentant celle-ci. Il est également possible d'accéder à un menu contextuel avec le bouton droit de la souris.")
        ...
        self.ctrl_options = CTRL_Locations_tableau.CTRL_Options(self, ctrl_tableau=self.ctrl_tableau)
