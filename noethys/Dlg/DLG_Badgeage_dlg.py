...
class CTRL_Bouton_toggle_archive(Control):
    def __init__(self, parent, id=-1, texte=u"", couleurClaire=(255, 255, 255), couleurFoncee=(255, 0, 0), selection=False, taille=wx.DefaultSize):
        ...
        # Ajustement de la hauteur du contr�le
        dc = wx.ClientDC(self)
...
class CTRL_Choix(wx.Panel):
    def __init__(self, parent, listeItems=[], multiSelection=True, couleurClaire=(255, 255, 255), couleurFoncee=(255, 0, 0), taille=(300, 70)):
        ...
        # Si s�lection unique, on s�lectionne par d�fautr le premier
        ...
        # Cr�ation des touches raccourcis
...
class DLG_Question(wx.Dialog):
    def __init__(self, interface, message=u"", icone=None, couleurClaire=wx.Colour(206, 196, 190), couleurFoncee=wx.Colour(169, 156, 146),
        ...
        # Regarde si un th�me existe dans l'interface
        if interface != None :
...
##        self.label_message = wx.StaticText(self, -1, u"\n".join(message))
        ...
        # D�sactive la touche OUI si multiSelection activ�e
        ...
        # Cr�ation de la forme de la fen�tre
        size = self.GetSize()
        if 'phoenix' in wx.PlatformInfo:
...
class DLG_Choix(DLG_Question):
    """ DLG qui propose diff�rents choix """
...
class DLG_Message(object):
    """ DLG pour afficher un message sur un temps donn� (en secondes) """
...
if __name__ == "__main__":
    ...
    # Version MESSAGE
##    dlg1 = DLG_Message(None, message="Bonjour K�vin", icone="commentaire", secondes=2)
    
    # Version QUESTION
##    dlg = DLG_Question(None, message=_(u"Restes-tu manger � la cantine ce midi ?"), icone="question")
