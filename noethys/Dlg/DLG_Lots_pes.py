...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour créer un bordereau"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le bordereau sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le bordereau sélectionné dans la liste"))
