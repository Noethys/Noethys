...
class Donnees():
    ...
    def GetVentes(self):
        ...
        # Récupération des types de cotisations
        req = """
        ...
        dict_types_cotisations = {IDprestation: code_comptable for IDprestation, code_comptable in listeDonnees}
        ...
        for IDprestation, datePrestation, categorie, code_compta_prestation, code_compta_tarif, label, montant, IDactivite, nomActivite, nomAbregeActivite, CodeComptableActivite, code_analytique_activite, IDtarif, nomTarif, nomCategorieTarif, IDfacture, forfait, IDcategorie_tarif, IDindividu, nomIndividu, prenomIndividu in listeDonnees :
            ...
            dictTemp = {
                ...
                "IDindividu" : IDindividu, "nomIndividu" : nomIndividu, "prenomIndividu" : prenomIndividu, "code_compta_type_cotisation" : dict_types_cotisations.get(IDprestation, ""),
                }
