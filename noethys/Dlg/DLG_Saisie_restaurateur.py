...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Nom
        self.staticbox_nom_staticbox = wx.StaticBox(self, -1, _(u"Nom du restaurateur"))
    ...
    def __set_properties(self):
        self.SetTitle(_(u"Ajout d'un restaurateur"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_(u"Saisissez le nom du restaurateur")))
