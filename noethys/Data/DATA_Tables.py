...
TABLES_IMPORTATION_OPTIONNELLES = [
    ...
    [u"Vaccins et maladies",
     ("types_vaccins", "vaccins_maladies", "types_maladies",), True],
    [u"Types de sieste", ("types_sieste",), True],
    [u"Catégories socio-professionnelles", ("categories_travail",), True],
    [u"Modes et émetteurs de règlements",
     ("modes_reglements", "emetteurs"), True],
    [u"Régimes d'appartenance", ("regimes",), True],
    [u"Modèles de documents",
     ("documents_modeles", "documents_objets"), True],
...
DB_DATA = {
    ...
    "individus": [("IDindividu", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID de la personne"),
                  ...
                  ("nom_jfille", "VARCHAR(100)",
                   u"Nom de jeune fille de la personne"),
                  ("prenom", "VARCHAR(100)", u"Prénom de la personne"),
                  ("num_secu", "VARCHAR(21)",
                   u"Numéro de sécurité sociale de la personne"),
                  ("IDnationalite", "INTEGER", u"Nationalité de la personne"),

                  ("date_naiss", "DATE", u"Date de naissance de la personne"),
                  ("IDpays_naiss", "INTEGER",
                   u"ID du Pays de naissance de la personne"),
                  ("cp_naiss", "VARCHAR(10)",
                   u"Code postal du lieu de naissance de la personne"),
                  ("ville_naiss", "VARCHAR(100)",
                   u"Ville du lieu de naissance de la personne"),
                  ("deces", "INTEGER", u"Est décédé (0/1)"),
                  ("annee_deces", "INTEGER", u"Année de décès"),

                  ("adresse_auto", "INTEGER",
                   u"IDindividu dont l'adresse est à reporter"),
                  ("rue_resid", "VARCHAR(255)",
                   u"Adresse de la personne"),
                  ("cp_resid", "VARCHAR(10)",
                   u"Code postal de la personne"),
                  ("ville_resid", "VARCHAR(100)",
                   u"Ville de la personne"),
                  ("IDsecteur", "INTEGER",
                   u"Secteur géographique"),

                  ("IDcategorie_travail", "INTEGER",
                   u"IDcategorie socio-professionnelle"),
                  ("profession", "VARCHAR(100)",
                   u"Profession de la personne"),
                  ("employeur", "VARCHAR(100)",
                   u"Employeur de la personne"),
                  ("travail_tel", "VARCHAR(50)",
                   u"Tel travail de la personne"),
                  ("travail_fax", "VARCHAR(50)",
                   u"Fax travail de la personne"),
                  ("travail_mail", "VARCHAR(50)",
                   u"Email travail de la personne"),

                  ("tel_domicile", "VARCHAR(50)",
                   u"Tel domicile de la personne"),
                  ("tel_mobile", "VARCHAR(50)",
                   u"Tel mobile perso de la personne"),
                  ("tel_fax", "VARCHAR(50)",
                   u"Fax perso de la personne"),
                  ("mail", "VARCHAR(200)",
                   u"Email perso de la personne"),

                  ("travail_tel_sms", "INTEGER",
                   u"SMS autorisé (0/1)"),
                  ("tel_domicile_sms", "INTEGER",
                   u"SMS autorisé (0/1)"),
                  ("tel_mobile_sms", "INTEGER",
                                     u"SMS autorisé (0/1)"),

                  ("IDmedecin", "INTEGER",
                   u"ID du médecin traitant de l'individu"),
                  ("memo", "VARCHAR(2000)",
    ...
    "liens": [("IDlien", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID du lien"),
              ...
              ("responsable", "INTEGER",
               u"=1 si l'individu SUJET est responsable de l'individu objet"),
    ...
    "familles": [("IDfamille", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID de la famille"),
                 ...
                 ("internet_identifiant", "VARCHAR(300)",
                  u"Code identifiant internet"),
                 ("internet_mdp", "VARCHAR(300)", u"Mot de passe internet"),
                 ("memo", "VARCHAR(2000)", u"Mémo concernant la famille"),
                 ("prelevement_activation", "INTEGER",
                  u"Activation du prélèvement"),
                 ("prelevement_etab", "VARCHAR(50)", u"Prélèvement - Code étab"),
                 ("prelevement_guichet", "VARCHAR(50)",
                  u"Prélèvement - Code guichet"),
                 ("prelevement_numero", "VARCHAR(50)",
                  u"Prélèvement - Numéro de compte"),
                 ("prelevement_cle", "VARCHAR(50)", u"Prélèvement - Code clé"),
                 ("prelevement_banque", "INTEGER",
                  u"Prélèvement - ID de la Banque"),
                 ("prelevement_individu", "INTEGER", u"Prélèvement - ID Individu"),
                 ("prelevement_nom", "VARCHAR(200)",
                  u"Prélèvement - nom titulaire"),
                 ("prelevement_rue", "VARCHAR(400)",
                  u"Prélèvement - rue titulaire"),
                 ("prelevement_cp", "VARCHAR(50)", u"Prélèvement - cp titulaire"),
                 ("prelevement_ville", "VARCHAR(400)",
                  u"Prélèvement - ville titulaire"),
                 ...
                 ("prelevement_reference_mandat", "VARCHAR(300)",
                  u"Prélèvement - Référence mandat"),
                 ("prelevement_date_mandat", "DATE", u"Prélèvement - Date mandat"),
                 ("prelevement_memo", "VARCHAR(450)", u"Prélèvement - Mémo"),
                 ("email_factures", "VARCHAR(450)",
                  u"Adresse Email pour envoi des factures"),
                 ("email_recus", "VARCHAR(450)",
                  u"Adresse Email pour envoi des reçus de règlements"),
                 ("email_depots", "VARCHAR(450)",
                  u"Adresse Email pour avis d'encaissement des règlements"),
                 ("titulaire_helios", "INTEGER", u"IDindividu du titulaire Hélios"),
                 ("code_comptable", "VARCHAR(450)",
                  u"Code comptable pour facturation et export logiciels compta"),
                 ("idtiers_helios", "VARCHAR(300)", u"IDtiers pour Hélios"),
                 ("natidtiers_helios", "INTEGER", u"Nature IDtiers pour Hélios"),
                 ("reftiers_helios", "VARCHAR(300)",
                  u"Référence locale du tiers pour Hélios"),
                 ("cattiers_helios", "INTEGER", u"Catégorie de tiers pour Hélios"),
                 ("natjur_helios", "INTEGER",
                  u"Nature juridique du tiers pour Hélios"),
                 ("autorisation_cafpro", "INTEGER",
                  u"Autorisation de consultation CAFPRO (0/1)"),
                 ("autre_adresse_facturation", "VARCHAR(450)",
                  u"Autre adresse de facturation"),
                 ("etat", "VARCHAR(50)", u"Etat"),
    ...
    "rattachements": [("IDrattachement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID rattachement"),
                      ...
                      ("IDcategorie", "INTEGER",
                       u"IDcategorie du rattachement (responsable|enfant|contact)"),
                      ("titulaire", "INTEGER",
    ...
    "problemes_sante": [("IDprobleme", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID du probleme de santé"),
                        ...
                        ("description", "VARCHAR(2000)",
                         u"Description du problème"),
                        ("traitement_medical", "INTEGER",
                         u"Traitement médical (1/0)"),
                        ("description_traitement", "VARCHAR(2000)",
                         u"Description du traitement médical"),
                        ("date_debut_traitement", "DATE",
                         u"Date de début du traitement"),
                        ("date_fin_traitement", "DATE",
                         u"Date de fin du traitement"),
                        ("eviction", "INTEGER", u"Eviction (1/0)"),
                        ("date_debut_eviction", "DATE",
                         u"Date de début de l'éviction"),
                        ("date_fin_eviction", "DATE",
                         u"Date de fin de l'éviction"),
                        ("diffusion_listing_enfants", "INTEGER",
                         u"Diffusion listing enfants (1/0)"),
                        ("diffusion_listing_conso", "INTEGER",
                         u"Diffusion listing consommations (1/0)"),
                        ("diffusion_listing_repas", "INTEGER",
                         u"Diffusion commande des repas (1/0)"),
    ...
    "types_pieces": [("IDtype_piece", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID type pièce"),
                     ...
                     ("duree_validite", "VARCHAR(50)", u"Durée de validité"),
                     ("valide_rattachement", "INTEGER",
                      u"(0|1) Valide même si individu rattaché à une autre famille"),
                     ],  # Types de pièces
    ...
    "activites": [("IDactivite", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Activité"),
                  ...
                  ("coords_org", "INTEGER",
                   u"(0/1) Coordonnées identiques à l'organisateur"),
                  ("rue", "VARCHAR(200)", u"Adresse"),
                  ("cp", "VARCHAR(10)", u"Code postal"),
                  ("ville", "VARCHAR(100)", u"Ville"),
                  ("tel", "VARCHAR(50)", u"Tel travail"),
                  ...
                  ("vaccins_obligatoires", "INTEGER",
                   u"(0/1) Vaccins obligatoires pour l'individu inscrit"),
                  ...
                  ("psu_unite_prevision", "INTEGER",
                   u"Mode PSU : IDunite prévision"),
                  ("psu_unite_presence", "INTEGER",
                   u"Mode PSU : IDunite présence"),
                  ("psu_tarif_forfait", "INTEGER",
                   u"Mode PSU : IDtarif forfait-crédit"),
                  ("psu_etiquette_rtt", "INTEGER",
                   u"Mode PSU : IDetiquette Absences RTT"),
                  ("portail_inscriptions_affichage", "INTEGER",
                   u"Inscriptions autorisées sur le portail (0/1)"),
                  ("portail_inscriptions_date_debut", "DATETIME",
                   u"Inscriptions autorisées - début d'affichage"),
                  ("portail_inscriptions_date_fin", "DATETIME",
                   u"Inscriptions autorisées - fin d'affichage"),
                  ("portail_reservations_affichage", "INTEGER",
                   u"Réservations autorisées sur le portail (0/1)"),
                  ("portail_reservations_limite", "VARCHAR(100)",
                   u"Date limite de modification d'une réservation"),
                  ("portail_reservations_absenti", "VARCHAR(100)",
                   u"Application d'une absence injustifiée"),
                  ("portail_unites_multiples", "INTEGER",
                   u"Sélection multiple d'unités autorisée (0/1)"),
                  ("regie", "INTEGER", u"ID de la régie associée"),
                  ("code_produit_local", "VARCHAR(200)",
                   u"Code produit local pour export compta"),
                  ("inscriptions_multiples", "INTEGER",
                   u"Autoriser les inscriptions multiples (0/1)"),
    ...
    "pieces_activites": [("IDpiece_activite", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Pièce activité"),
                         ...
                         ("IDtype_piece", "INTEGER",
                          u"ID du type de pièce à fournir"),
    ...
    "cotisations_activites": [("IDcotisation_activite", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Cotisation activité"),
                              ...
                              ("IDtype_cotisation", "INTEGER",
                               u"ID du type de cotisation à fournir"),
    ...
    "renseignements_activites": [("IDrenseignement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Renseignement"),
                                 ...
                                 ("IDtype_renseignement", "INTEGER",
                                  u"ID du type de renseignement à fournir"),
    ...
    "unites": [("IDunite", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Unité"),
               ...
               ("date_debut", "DATE", u"Date de début de validité"),
               ("date_fin", "DATE", u"Date de fin de validité"),
               ("touche_raccourci", "VARCHAR(30)",
                u"Touche de raccourci pour la grille de saisie"),
               ...
               ("autogen_conditions", "VARCHAR(400)",
                u"Conditions de l'autogénération"),
               ("autogen_parametres", "VARCHAR(400)",
                u"Paramètres de l'autogénération"),
               ],  # Unités
    ...
    "unites_remplissage": [("IDunite_remplissage", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Unité_remplissage"),
                           ...
                           ("seuil_alerte", "INTEGER",
                            u"Seuil d'alerte de remplissage"),
                           ("heure_min", "DATE",
                            u"Plage horaire conditionnelle - Heure min"),
                           ("heure_max", "DATE",
                            u"Plage horaire conditionnelle - Heure max"),
                           ("afficher_page_accueil", "INTEGER",
                            u"Afficher dans le cadre Effectifs de la page d'accueil"),
                           ("afficher_grille_conso", "INTEGER",
                            u"Afficher dans la grille des conso"),
    ...
    "unites_remplissage_unites": [("IDunite_remplissage_unite", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Unité_remplissage_unite"),
                                  ("IDunite_remplissage", "INTEGER",
                                   u"ID de l'unité de remplissage concernée"),
    ...
    "categories_tarifs_villes": [("IDville", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Ville"),
                                 ("IDcategorie_tarif", "INTEGER",
                                  u"ID de la catégorie de tarif concernée"),
                                 ("cp", "VARCHAR(10)", u"Code postal"),
    ...
    "noms_tarifs": [("IDnom_tarif", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID nom tarif"),
                    ("IDactivite", "INTEGER", u"ID de l'activité concernée"),
                    ("IDcategorie_tarif", "INTEGER",
                     u"ID categorie_tarif rattachée"),
    ...
    "tarifs": [("IDtarif", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID tarif"),
               ...
               ("condition_periode", "VARCHAR(100)",
                u"Type de tarif (prédéfini ou automatique)"),
               ...
               ("forfait_saisie_manuelle", "INTEGER",
                u"Saisie manuelle du forfait possible (0/1)"),
               ("forfait_saisie_auto", "INTEGER",
                u"Saisie automatique du forfait quand inscription (0/1)"),
               ("forfait_suppression_auto", "INTEGER",
                u"Suppression manuelle impossible (0/1)"),
               ("methode", "VARCHAR(50)", u"Code de la méthode de calcul"),
               ("categories_tarifs", "VARCHAR(300)",
                u"Catégories de tarifs rattachées à ce tarif"),
               ("groupes", "VARCHAR(300)", u"Groupes rattachés à ce tarif"),
               ("forfait_duree", "VARCHAR(50)", u"Durée du forfait"),
               ("forfait_beneficiaire", "VARCHAR(50)",
                u"Bénéficiaire du forfait (famille|individu)"),
               ...
               ("code_compta", "VARCHAR(200)",
                u"Code comptable pour export vers logiciels de compta"),
               ("date_facturation", "VARCHAR(450)",
                u"Date de facturation de la prestation"),
    ...
    "tarifs_lignes":          [("IDligne", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID ligne de tarif"),
                               ...
                               ("montant_enfant_1", "FLOAT",
                                u"Montant pour 1 enfant"),
                               ("montant_enfant_2", "FLOAT",
                                u"Montant pour 2 enfants"),
                               ("montant_enfant_3", "FLOAT",
                                u"Montant pour 3 enfants"),
                               ("montant_enfant_4", "FLOAT",
                                u"Montant pour 4 enfants"),
                               ("montant_enfant_5", "FLOAT",
                                u"Montant pour 5 enfants"),
                               ("montant_enfant_6", "FLOAT",
                                u"Montant pour 6 enfants et plus"),
                               ("nbre_enfants", "INTEGER",
                                u"Nbre d'enfants pour le calcul par taux d'effort"),
                               ("coefficient", "FLOAT", u"Coefficient"),
                               ("montant_min", "FLOAT",
                                u"Montant mini pour le calcul par taux d'effort"),
                               ("montant_max", "FLOAT",
                                u"Montant maxi pour le calcul par taux d'effort"),
                               ("heure_debut_min", "DATE",
                                u"Heure début min pour unités horaires"),
                               ("heure_debut_max", "DATE",
                                u"Heure début max pour unités horaires"),
                               ("heure_fin_min", "DATE",
                                u"Heure fin min pour unités horaires"),
                               ("heure_fin_max", "DATE",
                                u"Heure fin max pour unités horaires"),
                               ("duree_min", "DATE",
                                u"Durée min pour unités horaires"),
                               ("duree_max", "DATE",
                                u"Durée min pour unités horaires"),
                               ("date", "DATE", u"Date conditionnelle"),
                               ("label", "VARCHAR(300)",
                                u"Label personnalisé pour la prestation"),
                               ("temps_facture", "DATE",
                                u"Temps facturé pour la CAF"),
                               ("unite_horaire", "DATE",
                                u"Unité horaire pour base de calcul selon coefficient"),
                               ("duree_seuil", "DATE", u"Durée seuil"),
                               ("duree_plafond", "DATE", u"Durée plafond"),
                               ("taux", "FLOAT", u"Taux d'effort"),
                               ("ajustement", "FLOAT",
                                u"Ajustement (majoration/déduction)"),
                               ("montant_questionnaire", "INTEGER",
                                u"IDquestion de la table questionnaires"),
    ...
    "inscriptions": [("IDinscription", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID inscription"),
                     ...
                     ("IDcategorie_tarif", "INTEGER",
                      u"ID de la catégorie de tarif"),
                     ("IDcompte_payeur", "INTEGER",
                      u"ID du compte payeur par défaut"),
    ...
    "consommations": [("IDconso", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID consommation"),
                      ...
                      ("verrouillage", "INTEGER",
                       u"1 si la consommation est verrouillée"),
                      ("date_saisie", "DATE", u"Date de saisie de la consommation"),
                      ("IDutilisateur", "INTEGER",
                       u"Utilisateur qui a fait la saisie"),
                      ("IDcategorie_tarif", "INTEGER",
                       u"ID de la catégorie de tarif"),
                      ("IDcompte_payeur", "INTEGER", u"ID du compte payeur"),
                      ("IDprestation", "INTEGER", u"ID de la prestation"),
                      ("forfait", "INTEGER",
                       u"Type de forfait : 0 : Aucun | 1 : Suppr possible | 2 : Suppr impossible"),
                      ("quantite", "INTEGER", u"Quantité de consommations"),
                      ("etiquettes", "VARCHAR(50)", u"Etiquettes"),
                      ("IDevenement", "INTEGER", u"ID de l'évènement"),
                      ("badgeage_debut", "DATETIME",
                       u"Date et heure de badgeage du début"),
                      ("badgeage_fin", "DATETIME",
                       u"Date et heure de badgeage de fin"),
                      ],  # Consommations
    ...
    "prestations": [("IDprestation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID prestation"),
                    ...
                    ("montant_initial", "FLOAT",
                     u"Montant de la prestation AVANT déductions"),
                    ...
                    ("date_valeur", "DATE",
                     u"Date de valeur comptable de la prestation"),
    ...
    "modes_reglements": [("IDmode", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID mode de règlement"),
                         ...
                         ("numero_piece", "VARCHAR(10)",
                          u"Numéro de pièce (None|ALPHA|NUM)"),
                         ("nbre_chiffres", "INTEGER",
                          u"Nbre de chiffres du numéro"),
                         ("frais_gestion", "VARCHAR(10)",
                          u"Frais de gestion None|LIBRE|FIXE|PRORATA"),
                         ...
                         ("frais_label", "VARCHAR(200)",
                          u"Label de la prestation"),
                         ("type_comptable", "VARCHAR(200)",
                          u"Type comptable (banque ou caisse)"),
                         ("code_compta", "VARCHAR(200)",
                          u"Code comptable pour export vers logiciels de compta"),
                         ],  # Modes de règlements
    ...
    "comptes_bancaires": [("IDcompte", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Compte"),
                          ...
                          ("dft_iban", "VARCHAR(400)", u"Numéro IBAN du compte DFT"),
                            ("adresse_service", "VARCHAR(400)", u"Adresse service"),
                            ("adresse_rue", "VARCHAR(400)", u"Adresse rue"),
                            ("adresse_numero", "VARCHAR(400)", u"Adresse numéro"),
                            ("adresse_batiment", "VARCHAR(400)", u"Adresse batiment"),
                            ("adresse_etage", "VARCHAR(400)", u"Adresse étage"),
                            ("adresse_boite", "VARCHAR(400)", u"Adresse boite"),
                            ("adresse_cp", "VARCHAR(400)", u"Adresse cp"),
                            ("adresse_ville", "VARCHAR(400)", u"Adresse ville"),
                            ("adresse_pays", "VARCHAR(400)", u"Adresse pays"),
    ...
    "reglements": [("IDreglement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Règlement"),
                   ...
                   ("IDprestation_frais", "INTEGER",
                    u"ID de la prestation de frais de gestion"),
    ...
    "types_cotisations": [("IDtype_cotisation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID type cotisation"),
                          ...
                          ("type", "VARCHAR(50)",
                           u"Type de cotisation (individu/famille)"),
                          ("carte", "INTEGER", u"(0/1) Est une carte d'adhérent"),
                          ("defaut", "INTEGER",
                           u"(0/1) Cotisation sélectionnée par défaut"),
                          ("code_comptable", "VARCHAR(450)",
                           u"Code comptable pour facturation et export logiciels compta"),
                          ("code_produit_local", "VARCHAR(200)",
                           u"Code produit local pour export compta"),
    ...
    "unites_cotisations": [("IDunite_cotisation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID unité cotisation"),
                           ("IDtype_cotisation", "INTEGER",
                            u"ID du type de cotisation"),
                           ("date_debut", "DATE", u"Date de début de validité"),
                           ("date_fin", "DATE", u"Date de fin de validité"),
                           ("nom", "VARCHAR(200)", u"Nom de l'unité de cotisation"),
                           ("montant", "FLOAT", u"Montant"),
                           ("label_prestation", "VARCHAR(200)",
                            u"Label de la prestation"),
                           ("defaut", "INTEGER",
                            u"(0/1) Unité sélectionnée par défaut"),
    ...
    "cotisations": [("IDcotisation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID cotisation"),
                    ...
                    ("IDunite_cotisation", "INTEGER",
                     u"ID de l'unité de cotisation"),
                    ("date_saisie", "DATE", u"Date de saisie"),
                    ("IDutilisateur", "INTEGER", u"ID de l'utilisateur"),
                    ("date_creation_carte", "DATE",
                     u"Date de création de la carte"),
                    ("numero", "VARCHAR(50)", u"Numéro d'adhérent"),
                    ("IDdepot_cotisation", "INTEGER",
                     u"ID du dépôt des cotisations"),
                    ("date_debut", "DATE", u"Date de début de validité"),
                    ("date_fin", "DATE", u"Date de fin de validité"),
    ...
    "factures": [("IDfacture", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDfacture"),
                 ...
                 ("activites", "VARCHAR(500)",
                  u"Liste des IDactivité séparées par ;"),
                 ("individus", "VARCHAR(500)",
                  u"Liste des IDindividus séparées par ;"),
                 ...
                 ("prestations", "VARCHAR(500)",
                  u"Liste des types de prestations intégrées"),
    ...
    "textes_rappels": [("IDtexte", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDtexte"),
                       ...
                       ("texte_xml", "VARCHAR(5000)",
                        u"Contenu du texte version XML"),
                       ("texte_pdf", "VARCHAR(5000)",
                        u"Contenu du texte version PDF"),
    ...
    "utilisateurs": [("IDutilisateur", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDutilisateur"),
                     ...
                     ("profil", "VARCHAR(100)",
                      u"Profil (Administrateur ou utilisateur)"),
    ...
    "messages": [("IDmessage", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDmessage"),
                 ...
                 ("afficher_commande", "INTEGER",
                  u"Afficher sur la commande des repas"),
                 ...
                 ("afficher_facture", "INTEGER",
                  u"Afficher sur les factures de la famille"),
                 ("rappel_famille", "INTEGER",
                  u"Rappel à l'ouverture de la fiche famille"),
                 ],  # Messages

    "messages_categories": [("IDcategorie", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDcategorie"),
                            ("nom", "VARCHAR(255)", u"Nom de la catégorie"),
                            ("priorite", "VARCHAR(30)", u"Priorité"),
                            ("afficher_accueil", "INTEGER",
                             u"Afficher sur la page d'accueil"),
                            ("afficher_liste", "INTEGER",
                             u"Afficher sur la liste des conso"),
    ...
    "attestations": [("IDattestation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDattestation"),
                     ...
                     ("activites", "VARCHAR(450)",
                      u"Liste des IDactivité séparées par ;"),
                     ("individus", "VARCHAR(450)",
                      u"Liste des IDindividus séparées par ;"),
                     ("IDutilisateur", "INTEGER",
                      u"Utilisateur qui a créé l'attestation"),
                     ("date_debut", "DATE", u"Date de début de période"),
                     ("date_fin", "DATE", u"Date de fin de période"),
                     ("total", "FLOAT", u"Montant total de la période"),
                     ("regle", "FLOAT", u"Montant réglé pour la période"),
    ...
    "documents_modeles": [("IDmodele", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID"),
                          ...
                          ("categorie", "VARCHAR(200)",
                           u"Catégorie du modèle (ex : facture)"),
    ...
    "documents_objets": [("IDobjet", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID"),
                         ...
                         ("categorie", "VARCHAR(200)",
                          u"Catégorie d'objet (ex : rectangle)"),
                         ...
                         ("points", "VARCHAR(600)",
                          u"Points de lignes ou de polygones"),
                         ("image", "LONGBLOB", u"Image"),
                         ("typeImage", "VARCHAR(100)",
                          u"Type de l'image (logo, fichier)"),
                         ...
                         ("Xmodifiable", "INTEGER",
                          u"Position X est modifiable (0/1)"),
                         ("Ymodifiable", "INTEGER",
                          u"Position Y est modifiable (0/1)"),
                         ("largeur", "INTEGER", u"Largeur de l'objet"),
                         ("hauteur", "INTEGER", u"Hauteur de l'objet"),
                         ("largeurModifiable", "INTEGER",
                          u"Largeur modifiable (0/1)"),
                         ("hauteurModifiable", "INTEGER",
                          u"Hauteur modifiable (0/1)"),
                         ...
                         ("verrouillageLargeur", "INTEGER",
                          u"Hauteur verrouillée (0/1)"),
                         ("verrouillageHauteur", "INTEGER",
                          u"Hauteur verrouillée (0/1)"),
                         ("verrouillageProportions", "INTEGER",
                          u"Proportion verrouillée (0/1)"),
                         ("interditModifProportions", "INTEGER",
                          u"Modification proportions interdite (0/1)"),
                         ("couleurTrait", "VARCHAR(100)", u"Couleur du trait"),
                         ("styleTrait", "VARCHAR(100)", u"Style du trait"),
                         ("epaissTrait", "FLOAT", u"Epaisseur du trait"),
                         ("coulRemplis", "VARCHAR(100)",
                          u"Couleur du remplissage"),
                         ...
                         ("afficheNumero", "INTEGER",
                          u"Affiche numéro code-barres"),
                         ("IDdonnee", "INTEGER",
                          u"Donnée associée pour zone interactive"),
    ...
    "questionnaire_categories": [("IDcategorie", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID"),
                                 ...
                                 ("couleur", "VARCHAR(100)",
                                  u"Couleur de la catégorie"),
                                 ("label", "VARCHAR(400)",
                                  u"Label de la question"),
    ...
    "questionnaire_reponses": [("IDreponse", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID"),
                               ("IDquestion", "INTEGER",
                                u"ID de la question rattachée"),
                               ("IDindividu", "INTEGER",
                                u"ID de l'individu rattaché"),
                               ("IDfamille", "INTEGER",
                                u"ID de la famille rattachée"),
                               ("reponse", "VARCHAR(400)", u"Réponse"),
                               ("type", "VARCHAR(100)",
                                u"Type : Individu ou Famille, etc..."),
                               ("IDdonnee", "INTEGER",
                                u"ID de la donnée rattachée (IDindividu, IDfamille, etc...)"),
    ...
    "questionnaire_filtres": [("IDfiltre", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID"),
                              ...
                              ("categorie", "VARCHAR(100)",
                               u"Catégorie (ex: 'TARIF')"),
                              ("choix", "VARCHAR(400)", u"Choix (ex : 'EGAL'"),
                              ("criteres", "VARCHAR(600)",
                               u"Criteres (ex : '4;5')"),
    ...
    "niveaux_scolaires":  [("IDniveau", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID"),
                           ("ordre", "INTEGER", u"Ordre"),
                           ("nom", "VARCHAR(400)",
                            u"Nom du niveau (ex : Cours préparatoire)"),
                           ("abrege", "VARCHAR(200)",
                            u"Abrégé du niveau (ex : CP)"),
                           ],  # Niveaux scolaires
    ...
    "classes": [("IDclasse", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Classe"),
                ...
                ("date_fin", "DATE", u"Date de fin de période"),
                ("niveaux", "VARCHAR(300)",
                 u"Liste des niveaux scolaires de la classe"),
                ],  # Classes
    ...
    "transports_lieux": [("IDlieu", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Lieu"),
                         ("categorie", "VARCHAR(200)",
                          u"Catégorie du lieu (gare,aeroport,port,station)"),
    ...
    "transports_lignes": [("IDligne", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Ligne"),
                          ("categorie", "VARCHAR(200)",
                           u"Catégorie de la ligne (bus, car, métro, etc...)"),
    ...
    "transports": [("IDtransport", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Transport"),
                   ...
                   ("categorie", "VARCHAR(100)",
                    u"Catégorie du moyen de locomotion"),
                   ...
                   ("depart_localisation", "VARCHAR(400)",
                    u"Localisation du départ"),
                   ...
                   ("arrivee_localisation", "VARCHAR(400)",
                    u"Localisation de l'arrivée"),
                   ("date_debut", "DATE", u"Date de début"),
                   ("date_fin", "DATE", u"Date de fin"),
    ...
    "badgeage_actions":   [("IDaction", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Action"),
                           ...
                           ("action_demande", "VARCHAR(40)",
                            u"Demande si début ou fin"),
                           ...
                           ("action_icone", "VARCHAR(400)",
                            u"Icone pour boite de dialogue"),
                           ("action_duree", "VARCHAR(50)",
                            u"Durée d'affichage du message"),
                           ("action_frequence", "VARCHAR(450)",
                            u"Frequence diffusion message"),
                           ("action_vocal", "VARCHAR(400)",
                            u"Synthese vocale activation"),
    ...
    "badgeage_procedures": [("IDprocedure", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Procédure"),
                            ...
                            ("image", "VARCHAR(400)",
                             u"Image personnalisée pour thème"),
                            ("systeme", "VARCHAR(400)", u"Système de saisie"),
                            ("activites", "VARCHAR(400)",
                             u"Liste ID activites pour saisie par liste d'individus"),
                            ("confirmation", "INTEGER",
                             u"Confirmation identification (0/1)"),
                            ("vocal", "INTEGER", u"Activation synthèse vocale (0/1)"),
                            ("tutoiement", "INTEGER",
                             u"Activation du tutoiement dans les messages (0/1)"),
                            ],  # Badgeage : Procédures
    ...
    "corrections_phoniques": [("IDcorrection", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Correction"),
                              ...
                              ("correction", "VARCHAR(400)",
                               u"Correction phonique"),
    ...
    "prelevements": [("IDprelevement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID prélèvement"),
                     ...
                     ("prelevement_etab", "VARCHAR(50)",
                      u"Prélèvement - Code étab"),
                     ("prelevement_guichet", "VARCHAR(50)",
                      u"Prélèvement - Code guichet"),
                     ("prelevement_numero", "VARCHAR(50)",
                      u"Prélèvement - Numéro de compte"),
                     ...
                     ("prelevement_reference_mandat", "VARCHAR(300)",
                      u"Prélèvement - Référence mandat"),
                     ("prelevement_date_mandat", "DATE",
                      u"Prélèvement - Date mandat"),
    ...
    "lots_prelevements": [("IDlot", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID du lot de prélèvement"),
                          ...
                          ("IDmode", "INTEGER", u"ID du mode de règlement"),
                          ("reglement_auto", "INTEGER",
                           u"Règlement automatique (0/1)"),
                          ("observations", "VARCHAR(500)", u"Observations"),
                          ...
                          ("identifiant_service", "VARCHAR(200)",
                           u"Identifiant du service"),
                          ("poste_comptable", "VARCHAR(200)",
                           u"Poste comptable ou codique"),
    ...
    "sauvegardes_auto": [("IDsauvegarde", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDsauvegarde"),
                         ("nom", "VARCHAR(455)",
                          u"Nom de la procédure de sauvegarde auto"),
                         ("observations", "VARCHAR(455)", u"Observations"),
                         ("date_derniere", "DATE",
                          u"Date de la dernière sauvegarde"),
                         ("sauvegarde_nom", "VARCHAR(455)", u"Sauvegarde Nom"),
                         ("sauvegarde_motdepasse", "VARCHAR(455)",
                          u"Sauvegarde mot de passe"),
                         ("sauvegarde_repertoire", "VARCHAR(455)",
                          u"sauvegarde Répertoire"),
                         ("sauvegarde_emails", "VARCHAR(455)", u"Sauvegarde Emails"),
                         ("sauvegarde_fichiers_locaux", "VARCHAR(455)",
                          u"Sauvegarde fichiers locaux"),
                         ("sauvegarde_fichiers_reseau", "VARCHAR(455)",
                          u"Sauvegarde fichiers réseau"),
                         ("condition_jours_scolaires", "VARCHAR(455)",
                          u"Condition Jours scolaires"),
                         ("condition_jours_vacances", "VARCHAR(455)",
                          u"Condition Jours vacances"),
                         ("condition_heure", "VARCHAR(455)", u"Condition Heure"),
                         ("condition_poste", "VARCHAR(455)", u"Condition Poste"),
                         ("condition_derniere", "VARCHAR(455)",
                          u"Condition Date dernière sauvegarde"),
                         ("condition_utilisateur", "VARCHAR(455)",
                          u"Condition Utilisateur"),
                         ("option_afficher_interface", "VARCHAR(455)",
                          u"Option Afficher interface (0/1)"),
                         ("option_demander", "VARCHAR(455)",
                          u"Option Demander (0/1)"),
                         ("option_confirmation", "VARCHAR(455)",
                          u"Option Confirmation (0/1)"),
                         ("option_suppression", "VARCHAR(455)",
                          u"Option Suppression sauvegardes obsolètes"),
    ...
    "mandats": [("IDmandat", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDmandat"),
                ...
                ("individu_ville", "VARCHAR(400)",
                 u"Ville du titulaire de compte"),
                ...
                ("individu_service", "VARCHAR(400)", u"Adresse service"),
                ("individu_numero", "VARCHAR(400)", u"Adresse numéro"),
                ("individu_batiment", "VARCHAR(400)", u"Adresse batiment"),
                ("individu_etage", "VARCHAR(400)", u"Adresse étage"),
                ("individu_boite", "VARCHAR(400)", u"Adresse boite"),
                ("individu_pays", "VARCHAR(400)", u"Adresse pays"),
                ],  # Mandats SEPA
    ...
    "contrats": [("IDcontrat", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID contrat"),
                 ...
                 ("nbre_absences_prevues", "INTEGER",
                  u"Nombre d'absences prévues PSU"),
                 ("nbre_heures_regularisation", "INTEGER",
                  u"Nombre d'heures de régularisation PSU"),
                 ("arrondi_type", "VARCHAR(50)", u"Type d'arrondi sur les heures"),
                 ("arrondi_delta", "INTEGER",
                  u"Delta en minutes de l'arrondi sur les heures"),
                 ("duree_absences_prevues", "VARCHAR(50)",
                  u"Temps d'absences prévues PSU"),
                 ("duree_heures_regularisation", "VARCHAR(50)",
                  u"Temps de régularisation PSU"),
                 ("duree_tolerance_depassement", "VARCHAR(50)",
                  u"Temps de tolérance dépassements PSU"),
    ...
    "compta_operations": [("IDoperation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID opération"),
                          ...
                          ("IDcompte_bancaire", "INTEGER",
                           u"ID du compte bancaire"),
    ...
    "compta_virements": [("IDvirement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID virement"),
                         ...
                         ("IDoperation_credit", "INTEGER",
                          u"ID opération créditeur"),
                         ],  # Compta : Virements
    ...
    "compta_tiers":         [("IDtiers", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Tiers"),
                             ...
                             ("observations", "VARCHAR(450)", u"Observations"),
                             ("IDcode_comptable", "INTEGER",
                              u"ID du code comptable"),
                             ],  # Compta : Tiers
    ...
    "compta_budgets":    [("IDbudget", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Budget"),
                          ...
                          ("observations", "VARCHAR(200)",
                           u"Observations sur le budget"),
                          ("analytiques", "VARCHAR(450)",
                           u"Liste des postes analytiques associés"),
                          ("date_debut", "DATE", u"Date de début de période"),
                          ("date_fin", "DATE", u"Date de fin de période"),
                          ],  # Compta : Budgets
    ...
    "compta_categories_budget": [("IDcategorie_budget", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Categorie budget"),
                                 ...
                                 ("type", "VARCHAR(200)",
                                  u"Type de données (debit/crédit)"),
                                 ("IDcategorie", "INTEGER",
                                  u"ID de la catégorie rattachée"),
    ...
    "compta_operations_budgetaires": [("IDoperation_budgetaire", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID opération budgétaire"),
                                      ("type", "VARCHAR(200)",
                                       u"Type de données (debit/crédit)"),
                                      ("date_budget", "DATE",
                                       u"Date d'impact budgétaire"),
                                      ("IDcategorie", "INTEGER",
                                       u"ID de la catégorie"),
                                      ("IDanalytique", "INTEGER",
                                       u"ID du poste analytique"),
                                      ("libelle", "VARCHAR(400)",
                                       u"Libellé de la ventilation"),
                                      ("montant", "FLOAT",
                                       u"Montant de la ventilation"),
                                      ],  # Compta : Ventilation des opérations
    ...
    "factures_regies":              [("IDregie", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID régie de facturation"),
                                     ...
                                     ("numclitipi", "VARCHAR(50)",
                                      u"Numéro de client TIPI"),
                                     ("email_regisseur", "VARCHAR(100)",
                                      u"email du régisseur"),
                                     ("IDcompte_bancaire", "INTEGER",
                                      u"ID du compte bancaire associé"),
    ...
    "portail_periodes":             [("IDperiode", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID période"),
                                     ...
                                     ("date_debut", "DATE",
                                      u"Date de début de la période"),
                                     ("date_fin", "DATE",
                                      u"Date de fin de la période"),
                                     ("affichage", "INTEGER",
                                      u"Affiché sur le portail (0/1)"),
                                     ("affichage_date_debut", "DATETIME",
                                      u"Date et heure de début d'affichage"),
                                     ("affichage_date_fin", "DATETIME",
                                      u"Date et heure de fin d'affichage"),
                                     ("IDmodele", "INTEGER",
                                      u"IDmodele d'email rattaché à la période"),
                                     ("introduction", "VARCHAR(1000)",
                                      u"Texte d'introduction"),
                                     ("prefacturation", "INTEGER",
                                      u"Préfacturation (0/1)"),
    ...
    "portail_unites":               [("IDunite", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID unité"),
                                     ("IDactivite", "INTEGER",
                                      u"ID de l'activité"),
                                     ("nom", "VARCHAR(300)",
                                      u"Nom de l'unité de réservation"),
                                     ("unites_principales", "VARCHAR(300)",
                                      u"Unités de consommation principales"),
                                     ("unites_secondaires", "VARCHAR(300)",
                                      u"Unités de consommation secondaires"),
                                     ("ordre", "INTEGER", u"Ordre"),
                                     ],  # Unités de réservations pour le portail

    "portail_actions":              [("IDaction", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID action"),
                                     ("horodatage", "DATETIME",
                                      u"Horodatage de l'action"),
                                     ("IDfamille", "INTEGER", u"ID de la famille"),
                                     ("IDindividu", "INTEGER",
                                      u"ID de l'individu"),
                                     ("IDutilisateur", "INTEGER",
                                     ...
                                     ("categorie", "VARCHAR(50)",
                                      u"Catégorie de l'action"),
                                     ("action", "VARCHAR(50)", u"Nom de l'action"),
                                     ("description", "VARCHAR(300)",
                                      u"Description de l'action"),
                                     ("commentaire", "VARCHAR(300)",
                                      u"Commentaire de l'action"),
                                     ("parametres", "VARCHAR(300)",
                                      u"Paramètres de l'action"),
                                     ("etat", "VARCHAR(50)", u"Etat de l'action"),
                                     ("traitement_date", "DATE",
                                      u"Date du traitement de l'action"),
                                     ("IDperiode", "INTEGER", u"ID de la période"),
                                     ("ref_unique", "VARCHAR(50)",
                                      u"Référence unique de l'action"),
                                     ("reponse", "VARCHAR(450)",
                                      u"Réponse à l'action"),
                                     ("email_date", "DATE",
                                      u"Date de l'envoi de l'email de réponse"),
                                     ("IDpaiement", "INTEGER",
                                      u"ID du paiement en ligne"),
                                     ("ventilation", "VARCHAR(5000)",
                                      u"Ventilation du paiement"),
    ...
    "portail_reservations":         [("IDreservation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID réservation"),
                                     ...
                                     ("IDinscription", "INTEGER",
                                      u"ID de l'inscription"),
                                     ("IDunite", "INTEGER", u"ID de l'unité"),
                                     ("IDaction", "INTEGER", u"ID de l'action"),
                                     ("etat", "INTEGER",
                                      u"Ajout ou suppression de la réservation (1/0)"),
    ...
    "portail_reservations_locations": [("IDreservation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID réservation"),
                                       ("date_debut", "DATETIME",
                                        u"Date de début de la réservation"),
                                       ("date_fin", "DATETIME",
                                        u"Date de fin de la réservation"),
                                       ("IDlocation", "VARCHAR(255)",
                                        u"ID de la location"),
                                       ("IDproduit", "INTEGER",
                                        u"ID du produit associé"),
                                       ("IDaction", "INTEGER", u"ID de l'action"),
                                       ("etat", "VARCHAR(100)",
                                        u"ajouter, modifier ou supprimer"),
                                       ("resultat", "VARCHAR(100)",
                                        u"Résultat du traitement"),
                                       ("partage", "INTEGER",
                                        u"Partage du produit (0/1)"),
    ...
    "profils":                      [("IDprofil", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Profil"),
                                     ("label", "VARCHAR(400)", u"Nom de profil"),
                                     ("categorie", "VARCHAR(200)",
                                      u"Catégorie du profil"),
                                     ("defaut", "INTEGER",
                                      u"(0/1) Profil sélectionné par défaut"),
    ...
    "evenements":                  [("IDevenement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID évènement"),
                                    ("IDactivite", "INTEGER",
                                     u"ID de l'activité associée"),
                                    ("IDunite", "INTEGER",
                                     u"ID de l'unité de conso associée"),
                                    ("IDgroupe", "INTEGER",
                                     u"ID du groupe associé"),
                                    ("date", "DATE", u"Date de l'évènement"),
                                    ("nom", "VARCHAR(200)", u"Nom de l'évènement"),
                                    ("description", "VARCHAR(1000)",
                                     u"Description de l'évènement"),
                                    ("capacite_max", "INTEGER",
                                     u"Nombre d'inscrits max sur l'évènement"),
                                    ("heure_debut", "DATE",
                                     u"Heure de début de l'évènement"),
                                    ("heure_fin", "DATE",
                                     u"Heure de fin de l'évènement"),
                                    ("montant", "FLOAT",
                                     u"Montant fixe de la prestation"),
                                    ],  # Evènements

    "modeles_prestations":        [("IDmodele", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID prestation"),
                                   ("categorie", "VARCHAR(50)",
                                    u"Catégorie de la prestation"),
                                   ("label", "VARCHAR(200)",
                                    u"Label de la prestation"),
                                   ("IDactivite", "INTEGER", u"ID de l'activité"),
                                   ("IDtarif", "INTEGER", u"ID du tarif"),
                                   ...
                                   ("code_compta", "VARCHAR(200)",
                                    u"Code comptable pour export vers logiciels de compta"),
                                   ("public", "VARCHAR(50)",
                                    u"Type de public : famille ou individu"),
                                   ("IDtype_quotient", "INTEGER",
                                    u"ID du type de quotient"),
                                   ],  # Modèles de prestations


    "produits_categories":     [("IDcategorie", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Catégorie de produits"),
                                ("nom", "VARCHAR(200)",
                                 u"Nom de la catégorie"),
                                ("observations", "VARCHAR(1000)",
                                 u"Observations sur la catégorie"),
                                ("image", "LONGBLOB",
                                 u"Image de la catégorie en binaire"),
                                ],  # Catégories de produits

    "produits":                 [("IDproduit", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Produit"),
                                 ("IDcategorie", "INTEGER",
                                  u"ID de la catégorie associée"),
                                 ("nom", "VARCHAR(200)", u"Nom du produit"),
                                 ("observations", "VARCHAR(1000)",
                                  u"Observations sur le produit"),
                                 ("image", "LONGBLOB",
                                  u"Image du produit en binaire"),
                                 ("quantite", "INTEGER",
                                  u"Quantité du produit"),
                                 ("montant", "FLOAT",
                                  u"Montant fixe de la prestation"),
                                 ("activation_partage", "INTEGER",
                                  u"Activer le partage de la ressource (0/1)"),
                                 ],  # Produits
    ...
    "locations":                [("IDlocation", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID location"),
                                 ...
                                 ("observations", "VARCHAR(1000)",
                                  u"Observations sur la location"),
                                 ("date_saisie", "DATE",
                                  u"Date de saisie de la location"),
                                 ("date_debut", "DATETIME",
                                  u"Date et heure de début de location"),
                                 ("date_fin", "DATETIME",
                                  u"Date et heure de fin de location"),
                                 ("quantite", "INTEGER",
                                  u"Quantité du produit"),
                                 ("IDlocation_portail", "VARCHAR(100)",
                                  u"IDlocation sur le portail"),
                                 ("serie", "VARCHAR(100)",
                                  u"uuid de la série"),
                                 ("partage", "INTEGER",
                                  u"Autoriser le partage de la ressource (0/1)"),
    ...
    "locations_demandes":       [("IDdemande", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Demande"),
                                 ("date", "DATETIME",
                                  u"Date et heure de la demande"),
                                 ("IDfamille", "INTEGER", u"ID de la famille"),
                                 ("observations", "VARCHAR(1000)",
                                  u"Observations sur la location"),
                                 ("categories", "VARCHAR(1000)",
                                  u"liste ID categories souhaitées"),
                                 ("produits", "VARCHAR(1000)",
                                  u"liste ID produits souhaités"),
                                 ("statut", "VARCHAR(100)",
                                  u"Statut de la demande"),
                                 ("motif_refus", "VARCHAR(1000)",
                                  u"Motif du refus"),
                                 ("IDlocation", "INTEGER",
                                  u"ID de la location attribuée"),
    ...
    "periodes_gestion":             [("IDperiode", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Période"),
                                     ...
                                     ("observations", "VARCHAR(1000)",
                                      u"Observations"),
                                     ("verrou_consommations",
                                      "INTEGER", u"Verrouillage"),
                                     ("verrou_prestations",
                                      "INTEGER", u"Verrouillage"),
    ...
    "portail_elements":            [("IDelement", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDelement"),
                                    ...
                                    ("titre", "VARCHAR(300)",
                                     u"Titre de l'élément"),
                                    ("categorie", "VARCHAR(200)",
                                     u"Catégorie de l'élément"),
                                    ("date_debut", "DATETIME",
                                     u"Date et heure de début"),
                                    ("date_fin", "DATETIME",
                                     u"Date et heure de fin"),
                                    ("parametres", "VARCHAR(5000)",
                                     u"Paramètres divers"),
                                    ("texte_xml", "VARCHAR(25000)",
                                     u"Contenu du texte version XML"),
                                    ("texte_html", "VARCHAR(25000)",
                                     u"Contenu du texte version HTML"),
    ...
    "perceptions":                  [("IDperception", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID de la perception"),
                                     ...
                                     ("service", "VARCHAR(400)", u"Adresse service"),
                                     ("numero", "VARCHAR(400)", u"Adresse numéro"),
                                     ("batiment", "VARCHAR(400)", u"Adresse batiment"),
                                     ("etage", "VARCHAR(400)", u"Adresse étage"),
                                     ("boite", "VARCHAR(400)", u"Adresse boite"),
                                     ("pays", "VARCHAR(400)", u"Adresse pays"),
    ...
    "devis":                        [("IDdevis", "INTEGER PRIMARY KEY AUTOINCREMENT", u"IDdevis"),
                                     ...
                                     ("IDutilisateur", "INTEGER",
                                      u"Utilisateur qui a créé l'attestation"),
                                     ("date_debut", "DATE",
                                      u"Date de début de période"),
                                     ("date_fin", "DATE", u"Date de fin de période"),
                                     ("total", "FLOAT",
                                      u"Montant total de la période"),
                                     ("regle", "FLOAT",
                                      u"Montant réglé pour la période"),
                                     ("solde", "FLOAT",
                                      u"Solde à régler pour la période"),
                                     ],  # Devis
    ...
    "contacts":                     [("IDcontact", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID du contact"),
                                     ...
                                     ("prenom", "VARCHAR(100)",
                                      u"Prénom du contact"),
                                     ("rue_resid", "VARCHAR(255)",
                                      u"Adresse du contact"),
                                     ("cp_resid", "VARCHAR(10)",
                                      u"Code postal du contact"),
                                     ("ville_resid", "VARCHAR(100)",
                                      u"Ville du contact"),
                                     ("tel_domicile", "VARCHAR(50)",
                                      u"Tel de domicile du contact"),
                                     ("tel_mobile", "VARCHAR(50)",
                                      u"Tel du mobile du contact"),
                                     ("mail", "VARCHAR(200)",
                                      u"Email perso du contact"),
                                     ("site", "VARCHAR(100)",
                                      u"Adresse site internet"),
                                     ("memo", "VARCHAR(2000)",
                                      u"Mémo concernant le contact"),
...
DB_DOCUMENTS = {
    ...
    "documents": [("IDdocument", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID du document"),
                  ...
                  ("last_update", "VARCHAR(50)",
                   u"Horodatage de la dernière modification du document"),
                  ],  # BLOB documents
