...
DB_DATA = {
    ...
    "comptes_bancaires": [("IDcompte", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID Compte"),
                          ...
                          ("code_nne", "VARCHAR(400)",
                           u"Code NNE pour prélèvements auto."),
                          ("cle_rib", "VARCHAR(400)",
                           u"Clé RIB pour prélèvements auto."),
                          ("cle_iban", "VARCHAR(400)",
                           u"Clé IBAN pour prélèvements auto."),
                          ("iban", "VARCHAR(400)",
                           u"Numéro IBAN pour prélèvements auto."),
                          ("bic", "VARCHAR(400)",
                           u"Numéro BIC pour prélèvements auto."),
                          ("code_ics", "VARCHAR(400)",
                           u"Code NNE pour prélèvements auto."),
                          ("dft_titulaire", "VARCHAR(400)",
                           u"Titulaire du compte DFT"),
                          ("dft_iban", "VARCHAR(400)",
                           u"Numéro IBAN du compte DFT"),
    ...
    "pes_pieces": [("IDpiece", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID piece"),
                   ...
                   ("prelevement_titulaire", "VARCHAR(400)",
                    u"Titulaire du compte bancaire"),
    ...
    "perceptions":                  [("IDperception", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID de la perception"),
                                     ("nom", "VARCHAR(200)",
                                      u"Nom de la perception"),
                                     ("rue_resid", "VARCHAR(255)",
                                      u"Adresse de la perception"),
                                     ("cp_resid", "VARCHAR(10)",
                                      u"Code postal de la perception"),
                                     ("ville_resid", "VARCHAR(100)",
                                      u"Ville de la perception"),
