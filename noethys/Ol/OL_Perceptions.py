...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        self.SetEmptyListMsg(_(u"Aucune perception"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_(u"Liste des perceptions"), format="A", orientation=wx.LANDSCAPE)
        prt.Preview()
    ...
    def Supprimer(self, event):
        ...
        DB.Close()
        if nbreLots > 0 :
            dlg = wx.MessageDialog(self, _(u"Cette perception a déjà été attribuée à %d lots de prélèvements.\n\nVous ne pouvez donc pas la supprimer !") % nbreLots, _(u"Suppression impossible"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        
        # Confirmation de suppression
        dlg = wx.MessageDialog(self, _(u"Souhaitez-vous vraiment supprimer cette perception ?"), _(u"Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
