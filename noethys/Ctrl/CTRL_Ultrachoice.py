...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        donnees = [
            {"image" : wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Loupe.png"), wx.BITMAP_TYPE_ANY), "label" : _(u"Item 1"), "description" : _(u"Ceci est la description de l'item 1 qui est vraiment un texte tr�s long qui devrait normalement d�passer.")} ,
