...
class CTRL(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.checkbox_repertoire.SetToolTip(wx.ToolTip(_(u"Cochez cette case pour enregistrer un exemplaire de chaque document au format PDF dans le répertoire indiqué")))
