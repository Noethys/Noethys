...
LISTE_METHODES = [
    ...
    { "code" : "taux_date", "label": _(u"Par taux d'effort et par date"), "type": "unitaire", "nbre_lignes_max": 1, "entete": None, "champs": ("date", "taux", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires": ("date", "taux"), "tarifs_compatibles": ("JOURN",)},
