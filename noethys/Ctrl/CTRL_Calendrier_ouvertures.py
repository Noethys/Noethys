...
class Calendrier(HTL.HyperTreeList):
    def __init__(self, parent, IDactivite=None): 
        ...
        self.SetAGWWindowStyleFlag(wx.TR_HIDE_ROOT  | wx.TR_COLUMN_LINES | wx.TR_HAS_BUTTONS | wx.TR_HAS_VARIABLE_ROW_HEIGHT | wx.TR_FULL_ROW_HIGHLIGHT ) # HTL.TR_NO_HEADER
