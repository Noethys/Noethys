...
class CTRL_Parametres(CTRL_Propertygrid.CTRL) :
    ...
    def Remplissage(self):
        ...
        # Afficher le sous-total par activit�
        propriete = wxpg.BoolProperty(label=_(u"Afficher le sous-total par activit�"), name="afficher_sous_total_activite", value=False)
        propriete.SetHelpString(_(u"Cochez cette case si vous souhaitez afficher le sous-total par activit�"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
